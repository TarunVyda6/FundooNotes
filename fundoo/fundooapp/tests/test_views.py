...
class Data(TestCase):
    ...
    def setUp(self):
        ...
        self.valid_login_data = {
            'email': "kamaltarun.rao0@gmail.com",
            'password': "adminpass"}
        self.valid_login_data2 = {
            'email': "souravganguly123@gmail.com",
            'password': "adminpass"}
        ...
        self.valid_label_data2 = {
            'label_name': "sourav Note",
        }
        ...
        self.search_note_data = {
            "search_term": "my", }
        self.search_note_url = reverse("search")+"?q=my"
